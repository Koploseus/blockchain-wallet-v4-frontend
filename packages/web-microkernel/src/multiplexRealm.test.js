import multiplexRealm from './multiplexRealm.js'
...
it(`multiplexes use of a realm with a wrapper`, async () => {
  ...
  const sender1 = multiplexRealm({ tag: `multiplexed 1` }, a)
  const sender2 = multiplexRealm({ tag: `multiplexed 2` }, a)
  const receiver1 = multiplexRealm({ tag: `multiplexed 1` }, b)
  const receiver2 = multiplexRealm({ tag: `multiplexed 2` }, b)
